...
//! # Visitor
//!
//! See [svelte_oxide_ast::Visit] and [svelte_oxide_ast::VisitMut]

#![allow(clippy::wildcard_imports)] // allow for use `svelte_oxide_ast::ast::*`
...
use oxc_span::Span;
use svelte_oxide_ast::{ast::Root, AstBuilder, Trivias};
