...
use svelte_oxide_ast::template::{
    ...
    StyleDirectiveMetadata, StyleDirectiveModifier, SvelteBody, SvelteBodyName,
    SvelteComponent, SvelteComponentName, SvelteDocument, SvelteDocumentName,
    SvelteElement, SvelteElementMetadata, SvelteElementName, SvelteFragment,
    SvelteFragmentName, SvelteHead, SvelteHeadName, SvelteOptionsRaw,
    SvelteOptionsRawName, SvelteSelf, SvelteSelfName, SvelteWindow,
    SvelteWindowName, Text, TitleElement, TitleElementName,
    TransitionDirective, TransitionDirectiveModifier, UseDirective,
};

use crate::{
    errors::{
        attributes::{DuplicateAttribute, EmptyAttributeShorthand},
        elements::{InvalidElementContent, InvalidTagName},
        parse::{
            EmptyDirectiveName, InvalidBlockPlacement, InvalidClosingTag,
            InvalidDirectiveValue, InvalidTagPlacement, MissingAttributeValue,
            UnexpectedEof, UnexpectedToken,
        },
        special_elements::{
            DuplicateSvelteElement, InvalidSelfPlacement,
            InvalidSvelteComponentDefinition, InvalidSvelteElementDefinition,
            InvalidSvelteElementPlacement, InvalidSvelteTag,
            MissingSvelteComponentDefinition, MissingSvelteElementDefinition,
        },
    },
