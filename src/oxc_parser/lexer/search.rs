...
/// # Examples
/// ```
/// use crate::oxc_parser::lexer::search::{ByteMatchTable, byte_match_table};
///
...
/// ```
/// {
///   use crate::oxc_parser::lexer::search::ByteMatchTable;
///   #[allow(clippy::eq_op)]
...
/// # Examples
/// ```
/// use crate::oxc_parser::lexer::search::{SafeByteMatchTable, safe_byte_match_table};
///
...
/// ```
/// {
///   use crate::oxc_parser::lexer::search::SafeByteMatchTable;
///   #[allow(clippy::eq_op)]
    ...
    (
        ...
        'outer: loop {
                ...
                <= $lexer.source.end_for_batch_search_addr()
            {
                ...
                'inner: loop {
                    for _i in
                        0..crate::oxc_parser::lexer::search::SEARCH_BATCH_SIZE
                    {
